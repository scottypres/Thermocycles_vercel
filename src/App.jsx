...
function SchematicDiagram({ cycle }) {
  ...
  return (
    <svg viewBox="-40 0 440 330" style={{ width: "100%" }}>
      ...
      <text x={350} y={168} fill={K.workOut} fontSize={7.5} textAnchor="start" fontFamily={FM} fontWeight="500">W_t</text>
      <text x={350} y={180} fill={K.workOut} fontSize={7} textAnchor="start" fontFamily={FM}>{fmt(cycle.wTurbine)} kJ/kg</text>
