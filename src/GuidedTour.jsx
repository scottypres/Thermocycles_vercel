...
export const BRAYTON_TOUR_STEPS = [
  ...
  { target: "bry-visualizer", title: "Specific Volume Visualizer", description: "Air stays a gas throughout the Brayton cycle, so instead of phases this box shows specific volume: its width shrinks as the air is compressed and grows as it expands, while particle speed and colour track temperature." },
